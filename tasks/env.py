...
@task(default=True, aliases=['export'])
def lock(ctx):
    """Update the environment-lock.yml file from the current `sipn-reanalysis-plots` environment."""
    print_and_run(f"conda env export -n sipn-reanalysis-plots > {ENV_LOCKFILE}")
